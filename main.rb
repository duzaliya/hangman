...
# readlines - возвращает массив считанных строк
...
# "сыграть" букву, то есть передать экземпляру класса game, что эта буква сыграна
  game.play!(letter)

end
# 4. Вывести финальное состояние игры
# после того, как игра закончена, мы сыграли последнюю букву,
# надо вывести очередное состояние игры - то есть результат
console_interface.print_out
